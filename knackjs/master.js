...
$(document).on('knack-view-render.view_7875', function(event, view, data) {
  var token = Knack.getUserAttributes().values["field_6440"];
  $('div[class="field_3"]').html('<iframe src="https://www.stellantisandyou.co.uk/digital-orders?token='+encodeURIComponent(token) + '#fleet-hub-reporting/fleet-digital-adoption" allow="camera" frameborder="0" width="100%" id="knack-iframe"></iframe>');
});
