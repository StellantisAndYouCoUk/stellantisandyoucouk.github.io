...
$(document).on("knack-scene-render.scene_508", function(event, scene, data) {
    let refreshData = [
      {
          mainField : 'field_2984', //Dealer tyres
          views:['1475']
      }
    ]
    sceneRefresh(refreshData);
...
$(document).on("knack-scene-render.scene_508", function(event, scene, data) {
    let refreshData = [
      {
          mainField : 'field_2984', //Autoline Tyre Stock For Dealer
          views:['1475']
      }
    ]
    sceneRefresh(refreshData);
...
//tooltipsTable('761','2246','field_4089','field_3781');
...
//	tooltipsTable('1017','3168','field_4089','field_3781');
	//	$('th[class="field_4089"]').hide();
  //$('td[class*="field_4089"]').hide();
	  $('th[class="field_2240"]').hide();
    $('td[class*="field_2240"]').hide();
...
$(document).on('knack-view-render.view_2722', function (event, view, data) {
  ...
  tooltipsTable('755','2722','field_1532','field_2586');
	...
	tooltipsTable('755','2722','field_4089','field_3781');
		$('th[class="field_4089"]').hide();
  $('td[class*="field_4089"]').hide();
	  $('th[class="field_2240"]').hide();
    $('td[class*="field_2240"]').hide();
...
$(document).on('knack-view-render.view_2892', function (event, view, data) {
  ...
  tooltipsTable('934','2892','field_1532','field_2586');
	...
	//tooltipsTable('934','2892','field_4089','field_3781');
		//$('th[class="field_4089"]').hide();
//  $('td[class*="field_4089"]').hide();
	  $('th[class="field_2240"]').hide();
    $('td[class*="field_2240"]').hide();
...
$(document).on('knack-view-render.view_2686', function(event, view, records) {
  let defineButtons = [{linkText:'All',filters:[]},
  {linkText:'TODAY\'s Jobs',filters:[{"field_name":"CA Today's Jobs that Still Has Labour And/OR Parts still To Complete","field":"field_2279","value":true,"operator":"is"}]},
  {linkText:'Comp. TODAY',filters:[{"field_name":"Date/Time Workshop marked as job completed for today","field":"field_2719","value":true,"operator":"is not blank"}]},
  {linkText:'Time Agreed TODAY',filters:[{"field_name":"Agreed Collection Time with Customer","field":"field_1117","value":true,"operator":"is today"}]},
  {linkText:'Checked In TODAY',filters:[{"field_name":"Date Vehicle Checked In Onsite (From Autoline)","field":"field_763","value":true,"operator":"is today"}]},
  {linkText:'Write up TODAY',filters:[{"field_name":"Date/Time Technician Write up completed","field":"field_2722","value":{"date":"","time":"","am_pm":"Invalid date","hours":null,"all_day":false,"minutes":null},"operator":"is today"}]},
  {linkText:'Ready to Invoice',filters:[{"field_name":"ready to invoice","field":"field_1717","value":"Parts + Labour","operator":"contains"}]},
  {linkText:'Currently Clocked',filters:[{"field":"field_1537","value":"Working on Currently","operator":"contains"}]},
  {linkText:'Never Clocked',filters:[{"field":"field_787","value":{"date":"","time":"","am_pm":"Invalid date","hours":null,"all_day":false,"minutes":null},"operator":"is blank"}]},
  {linkText:'Parts Avail',filters:[{"field":"field_985","value":"Working On Currently","operator":"is blank"}]},
  {linkText:'Parts Unavail',filters:[{"field":"field_985","value":"Working On Currently","operator":"is not blank"}]},
  {linkText:'Wait. Auth (VHC)',filters:[{"field":"field_2297","value":"CPL","operator":"is"}]},
  {linkText:'No CA\'s Linked',filters:[{"field":"field_1121","value":"","operator":"is blank"}]},
  {linkText:'Outstanding Messages',filters:[{"field":"field_2578","value":"","operator":"is not blank"}]},
  {linkText:'i0001',filters:[{"field":"field_756","value":"i0001","operator":"is"}]},
  {linkText:'i0002',filters:[{"field":"field_756","value":"i0002","operator":"is"}]},
  {linkText:'Await\' Wash',filters:[{"field":"field_2201","value":"Added to Service Wash List","operator":"is"}]},
  {linkText:'Wash Comp',filters:[{"field":"field_2201","value":"Service Wash Complete","operator":"is"}]},
  {linkText:'C/D Collected',filters:[{"field":"field_2785","value":{"date":"","time":"","am_pm":"Invalid date","hours":null,"all_day":false,"minutes":null},"operator":"is not blank"}]},
  {linkText:"DC – PRA","filters":[{"field_name":"Internal Job Card Status","field":"field_3781","value": "Diag complete – Requires Prior Approval","operator":"contains"}]},
...
console.log('found scene 1487');
    let refreshData = [
      {
          mainField : 'field_4877', //Line Number
          views:['4874','4875']
      }
    ]
    sceneRefresh(refreshData);
...
//PO upload customer filters
  ...
  {linkText:'SG_F',filters:[{"field_name":"Supplier Code","field":"field_3297","value": "F","operator":"contains"},{"field_name":"(GENERAL) Dealer Specific Information","field":"field_3291","value": "6079c2856e9561001d33ac06","operator":"is"}]},
  {linkText:'SG_P',filters:[{"field_name":"Supplier Code","field":"field_3297","value": "P","operator":"contains"},{"field_name":"(GENERAL) Dealer Specific Information","field":"field_3291","value": "6079c2856e9561001d33ac06","operator":"is"}]},
...
{linkText:'Photos/Videos',filters:[{"field_name":"Photo/Video Of Fault","field":"field_1105","value": "","operator":"is not blank"}]}, 
  {linkText:'Breakdown Reports',filters:[{"field_name":"Breakdown Report","field":"field_1526","value": "","operator":"is not blank"}]}
  ]
...
//workshop table for crawley
$(document).on('knack-scene-render.scene_1654', function(event, scene) {	
  //Tooltip table 3595
  tooltipsTable('1654','3595','field_1532','field_2586');
	tooltipsTable('1654','3595','field_1537','field_2213');  
  //Tooltip table 5272
  tooltipsTable('1654','5272','field_1532','field_2586');
	tooltipsTable('1654','5272','field_1537','field_2213');  
	tooltipsTable('1654','5272','field_2298','field_2272');

  recursiveSceneRefresh('1654',['view_5272'],300000);
	console.log('Recursivecallscene_1654');
});



var view_5272_refreshDateTime = new Date();
//hover for labour details on workshop table
$(document).on('knack-view-render.view_5272', function (event, view, data) {
...
console.log("renderSYSearchButtons('5272',defineButtons);")
  renderSYSearchButtons('5272',defineButtons);
  ...
  if (addFilters){
    ...
    $('div[id="view_5272"] a[class*="knViewLink"]').has('i[class="fa fa-check-circle"]').on( "click", function() {
      console.log('something clicked',(new Date()-view_5272_refreshDateTime));
      if ((new Date()-view_5272_refreshDateTime)>30*60*1000){
        view_5272_refreshDateTime = new Date()
        console.log('doRefresh');
        document.location.reload();
      }
    });
