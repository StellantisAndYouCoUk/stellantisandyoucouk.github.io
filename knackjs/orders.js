...
$(document).on('knack-form-submit.view_2765', function(event, view, data) { 
	let commandURL = /*integromat*/"https://davidmale--server.apify.actor/makeWebhook?token=apify_api_nf36PzXI3ydzk2UnFjwWVzrzCHRWOc2srqhw&webhook=lnunp83lom13c9swu0vgabmurbjxj5x6" ;
...
$(document).on('knack-form-submit.view_3855', function(event, view, data) {
    ...
    console.log("Test 2");
    try{
        let commandURL = /*integromat*/"https://davidmale--server.apify.actor/makeWebhook?token=apify_api_nf36PzXI3ydzk2UnFjwWVzrzCHRWOc2srqhw&webhook=ue6mctvmfbukksn2battr5cqtgnx135v";
...
$(document).on('knack-form-submit.view_2584', function(event, view, data) {
    ...
    let commandURL = /*integromat*/"https://davidmale--server.apify.actor/makeWebhook?token=apify_api_nf36PzXI3ydzk2UnFjwWVzrzCHRWOc2srqhw&webhook=o8f4wtbtada9lh4bzgj34o3qc0dpa3dx";
...
$(document).on('knack-form-submit.view_3750', function(event, view, data) { 
    ...
    try{
    let commandURL = /*integromat*/"https://davidmale--server.apify.actor/makeWebhook?token=apify_api_nf36PzXI3ydzk2UnFjwWVzrzCHRWOc2srqhw&webhook=891sve7f9q43lop42hpsa1wkt61qqfjy";
...
$(document).on('knack-form-submit.view_3567', function(event, view, data) { 
    ...
    try{
    let commandURL = /*integromat*/"https://davidmale--server.apify.actor/makeWebhook?token=apify_api_nf36PzXI3ydzk2UnFjwWVzrzCHRWOc2srqhw&webhook=myx89w3wyjsq3plni1yftp4h7ngv3o5p";
    let dataToSend = JSON.stringify({"Record ID":data.id, "Source Of Payload":"knack direct"});
...
$(document).on('knack-form-submit.view_2630', function(event, view, data) {
    ...
    let commandURL = /*integromat*/"https://davidmale--server.apify.actor/makeWebhook?token=apify_api_nf36PzXI3ydzk2UnFjwWVzrzCHRWOc2srqhw&webhook=ajxkfooskhy153u7ebtlipjmcfyp8guh";
...
$(document).on('knack-form-submit.view_2828', function(event, view, data) { 
    ...
    try{
      if(data.field_6553_raw === "Showroom Order"){
        ...
        let commandURL = /*integromat*/"https://davidmale--server.apify.actor/makeWebhook?token=apify_api_nf36PzXI3ydzk2UnFjwWVzrzCHRWOc2srqhw&webhook=1ikhk4iopuuiwivpcpb58ulbsaey5x96";
        ...
        let commandURL = /*integromat*/"https://davidmale--server.apify.actor/makeWebhook?token=apify_api_nf36PzXI3ydzk2UnFjwWVzrzCHRWOc2srqhw&webhook=4ps7dsjgushppofbwo4npmjdi8u0s8dw";
        let dataToSend = JSON.stringify({"RecordID":data.id, "Source Of Payload":"knack direct"});
...
$(document).on('knack-form-submit.view_2855', function(event, view, data) { 
     ...
     try{  
        ...
        let commandURL = /*integromat*/"https://davidmale--server.apify.actor/makeWebhook?token=apify_api_nf36PzXI3ydzk2UnFjwWVzrzCHRWOc2srqhw&webhook=c81bcra3lmhe7dlj3dvbcev551frqdf3";
...
$(document).on('knack-form-submit.view_2630', function(event, view, data) { 
    ...
    try{
        ...
        let commandURL = /*integromat*/"https://davidmale--server.apify.actor/makeWebhook?token=apify_api_nf36PzXI3ydzk2UnFjwWVzrzCHRWOc2srqhw&webhook=27gimyyfnsdz3jfji1q5b4ag65xx9wzc";
...
$(document).on('knack-form-submit.view_3685', function(event, view, data) { 
    ...
    try{
        ...
        let commandURL = /*integromat*/"https://davidmale--server.apify.actor/makeWebhook?token=apify_api_nf36PzXI3ydzk2UnFjwWVzrzCHRWOc2srqhw&webhook=6aee4yo8i2g1chdo9hphjnaw4n42ldor";
...
/*$(document).on('knack-form-submit.view_2674', function(event, view, data) {
    ...
    try{
        ...
        if(data.field_6567_raw === null || data.field_6567_raw === undefined){
            ...
            let commandURL = "https://davidmale--server.apify.actor/makeWebhook?token=apify_api_nf36PzXI3ydzk2UnFjwWVzrzCHRWOc2srqhw&webhook=4dol6uz8aoiou9zoryloi8mdbnm8qq3d";
...
$(document).on('knack-form-submit.view_3927', function(event, view, data) {
    ...
    let commandURL1 = /*integromat*/"https://davidmale--server.apify.actor/makeWebhook?token=apify_api_nf36PzXI3ydzk2UnFjwWVzrzCHRWOc2srqhw&webhook=3e3g6ao4wr3kcgmoejfrgtmeiohlg8rj";
...
$(document).on('knack-form-submit.view_2745', function(event, view, data) { 
    ...
    try{
        ...
        let commandURL = /*integromat*/"https://davidmale--server.apify.actor/makeWebhook?token=apify_api_nf36PzXI3ydzk2UnFjwWVzrzCHRWOc2srqhw&webhook=wbis2xdxwspei1lilnkle6db1tvbuh5r";
...
$(document).on('knack-form-submit.view_4314', function(event, view, data) { 
    ...
    try{
        ...
        let commandURL = /*integromat*/"https://davidmale--server.apify.actor/makeWebhook?token=apify_api_nf36PzXI3ydzk2UnFjwWVzrzCHRWOc2srqhw&webhook=xu1jig54toecb6zdlvffvktb2xcogpbe";
...
$(document).on('knack-form-submit.view_4406', function(event, view, data) { 
    ...
    try{
        ...
        let commandURL = /*integromat*/"https://davidmale--server.apify.actor/makeWebhook?token=apify_api_nf36PzXI3ydzk2UnFjwWVzrzCHRWOc2srqhw&webhook=3ih7yd1o9ajo23arn5v72zar3nd5m22p";
        let dataToSend = JSON.stringify({"Record ID":data.id});
...
$(document).on('knack-form-submit.view_4460', function(event, view, data) { 
	let commandURL = /*integromat*/"https://davidmale--server.apify.actor/makeWebhook?token=apify_api_nf36PzXI3ydzk2UnFjwWVzrzCHRWOc2srqhw&webhook=6qso0xkjtnf1kdy37qs7t8fdsvjgkr3q" ;
